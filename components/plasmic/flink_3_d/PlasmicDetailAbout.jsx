...
import sty from "./PlasmicDetailAbout.module.css"; // plasmic-import: fdr6e3UzDOBG/css
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div className={classNames(projectcss.all, sty.column___7Yylt)}>
            <PlasmicImg__
          ...
          <div className={classNames(projectcss.all, sty.column__nnGa1)}>
            <h5
