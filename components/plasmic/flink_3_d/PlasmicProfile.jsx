...
import sty from "./PlasmicProfile.module.css"; // plasmic-import: 3UyAhD3cARWv/css
    ...
    <React.Fragment>
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          <PlasmicImg__
            alt={""}
            className={classNames(sty.img__zxO4)}
            displayHeight={"auto"}
          ...
          <PlasmicImg__
            alt={""}
            className={classNames(sty.img__nzEm)}
            displayHeight={"auto"}
            displayMaxHeight={"none"}
            displayMaxWidth={"100%"}
            displayMinHeight={"0"}
          ...
          <PlasmicImg__
            alt={""}
            className={classNames(sty.img__jYeWt)}
            displayHeight={"auto"}
            displayMaxHeight={"none"}
            displayMaxWidth={"100%"}
            displayMinHeight={"0"}
          ...
          >
            <div className={classNames(projectcss.all, sty.freeBox__oZMs)}>
              <div
                data-plasmic-name={"columns"}
                data-plasmic-override={overrides.columns}
                className={classNames(projectcss.all, sty.columns)}
              >
                <div className={classNames(projectcss.all, sty.column___53Cfb)}>
                  <PriceCard
                    borders={["flatLeft"]}
                    className={classNames(
                      "__wab_instance",
                      sty.priceCard__dfFhD
                    )}
                  />
                </div>
                <div className={classNames(projectcss.all, sty.column__gHyAu)}>
                  <PriceCard
                    borders={["flatCenter"]}
                    className={classNames(
                      "__wab_instance",
                      sty.priceCard__nynqH
                    )}
                  />

                  <div
                    className={classNames(projectcss.all, sty.freeBox__qaHsU)}
                  >
                    <div
                ...
                <div className={classNames(projectcss.all, sty.column__ud5E)}>
                  <PriceCard
                    borders={["flatRight"]}
                    className={classNames(
                      "__wab_instance",
                      sty.priceCard__gil6J
                    )}
                  />
                </div>
              </div>
